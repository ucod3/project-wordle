...
![Demo showing the finished product, our Wordle clone](./public/images/wordle-demo.gif)
...
![Screenshot showing the guess input UI](./public/images/guess-input.png)
...
![Screen recording showing the guess being entered. It gets logged to the console, and erased from the input](./public/images/submit-guess.gif)
...
![Screen recording showing each guess printed out above the text input from the last exercise](./public/images/printed-word-list.gif)
...
![Screenshot of real Wordle, showing a 5x6 grid](./public/images/wordle-squares.png)
...
![Screen recording showing each guess being added to the 5x6 grid](./public/images/words-in-cells.gif)
...
![Screen recording. The guesses are applied to the game board, and the background colors update accordingly](./public/images/words-with-backgrounds.gif)
...
![Screenshot of a won game, showing a green success banner](./public/images/happy-banner.png)

If the user loses the game, by contrast, a sad banner should be shown:

![Screenshot of a won game, showing a red failure banner](./public/images/sad-banner.png)
...
![Screenshot of the Wordle game, showing a keyboard below the game board](./public/images/bottom-keyboard-original.png)
...
![Screenshot of our Wordle clone, showing a keyboard below the game board](./public/images/bottom-keyboard-clone.png)
